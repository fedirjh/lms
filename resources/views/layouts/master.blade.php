...
.cour{
  box-shadow: 0 2px 10px 0 rgba(50, 50, 93, 0.72), 0 5px 15px 0 rgba(255, 255, 255, 0.07) !important;
  border-radius: 0.5rem !important;
}
.cour .card-header:first-child {
                            ...
                            @auth
                              ...
                              <li class="nav-item dropdown">
                                  ...
                                  <div class="dropdown-menu">
                                      ...
                                      <a class="dropdown-item" href="{{route('categorie.index')}}">Categories</a>
                                      @endif
                                      <a class="dropdown-item" href="{{route('formation.index')}}">Formations</a>
                                      <a class="dropdown-item" href="{{route('cour.index')}}">Cours</a>
                                      <a class="dropdown-item" href="{{route('qcms.index')}}">Qcms</a>
                                      <a class="dropdown-item" href="{{route('questions.index')}}">Questions</a>
                                      <a class="dropdown-item" href="{{route('questions_options.index')}}">Question Options</a>
                                      <a class="dropdown-item" href="{{route('results.index')}}">Results</a>
                                      <a class="dropdown-item" href="{{route('comments.index')}}">Comments</a>
                                  </div>
                              </li>
                              @endif
                              <li class="nav-item dropdown">
                                  <a href="{{route('myresults')}}" class="nav-link">Results</a>
                              </li>
                            @endauth
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Formations</a>
                                <div class="dropdown-menu">
                                  @foreach (App\Formation::all() as $item)
                                    <a class="dropdown-item" href="{{route('getFormation',$item->id)}}">{{ $item->nom }}</a>
                                  @endforeach
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Cours</a>
                                <div class="dropdown-menu">
                                  @foreach (App\Cour::all() as $item)
                                    <a class="dropdown-item" href="{{route('getCourse',[$item->formation->id,$item->id])}}">{{ $item->titre }}</a>
                                  @endforeach
                                </div>
                            </li>
                        </ul>
